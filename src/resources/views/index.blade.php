...
<body>
    ...
    <div class="app-layout">
        ...
        <main class="stage">
            ...
            @include('streampackage::components.help')

            @include('streampackage::components.settings')

            @include('streampackage::components.topUpCoin')

            @include('streampackage::components.guests')

            @include('streampackage::components.network')

            @include('streampackage::components.liveStream')

            @include('streampackage::components.analytics')
      ...
      <div class="qna-actions">
        ...
        <small style="font-size:9px;color:#ffd700">🪙${g.c}</small>`;
                    el.onclick = () => {
                        ...
                        c.innerHTML +=
                            `<div class="chat-msg"><strong>User:</strong> Sent ${g.n} ${g.i}</div>`;
